...
function _Drums (_sequence, _timeValue, _amp, _freq){
	...
	this.sounds = {
		kick 	: { sampler: Gibberish.Sampler("http://localhost/gibber/audiofiles/kick.wav"), pitch:1, amp:this.amp },
		snare	: { sampler: Gibberish.Sampler("http://localhost/gibber/audiofiles/snare.wav"),pitch:1, amp:this.amp },
		hat		: { sampler: Gibberish.Sampler("http://localhost/gibber/audiofiles/hat.wav"), 	pitch:1, amp: this.amp }, 
		openHat	: { sampler: Gibberish.Sampler("http://localhost/gibber/audiofiles/openhat.wav"), pitch:1, amp:this.amp },
	}
